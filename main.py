...
def topThreeVideoGames():
        ...
        print("zelda ocarina of time")

        #print second video game
        print("zelda twilight princess")

        #print third movie
        print("mario cart wii")

topThreeVideoGames()
print("cat" * 420)

def myNameIs(MEWHENYOURMOM):
    #myname
    print(MEWHENYOURMOM + " is my name")
